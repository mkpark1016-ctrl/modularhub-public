...
def test_view_model_contains_yuchang_kumkang_and_daeseung() -> None:
    payload = load_output()
    assert [company["company_id"] for company in payload["companies"]] == ["daeseung-engineering", "dl-enc", "geogwang-enterprise", "gs-ec", "hyundai-engineering", "kumkang-kind", "nrb", "planm", "samsung-ct-construction", "sungji-steel", "yuchang-enc"]
