...
- **오늘의 영업 브리핑:** 진행 중 사업, 마감 7일 이내 사업, 최근 7일 신규 사업, 중요공고, 최근 7일 뉴스를 표시합니다.
- **사업 우선순위:** 진행 중이고 D-7 이하이거나 중요공고이면 `즉시 검토`, 최근 등록·모듈러 명시·공공기관 공모이면 `이번 주 검토`, 그 외 진행 중 사업은 `관찰`, 마감 사업은 `마감`으로 표시합니다. 화면에는 점수 대신 `마감 D-3`, `중요공고`, `최근 등록`, `모듈러 명시`, `공공기관 공모`처럼 판정 이유를 함께 보여줍니다.
